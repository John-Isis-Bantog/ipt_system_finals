<x-layout>
  ...
  <div class="">
    <img class="w-32" src="{{ asset('logo.png') }}" alt="Your Photo">
  </div>
  ...
  <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
    ...
    <form class="space-y-4 md:space-y-6" action="#">
      ...
      <div>
        ...
        <button type="submit" class="w-full text-white dark:bg-blue-700 dark:hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800 mt-5">Sign in</button>
      </div>
      <p class="text-sm font-light text-gray-500 dark:text-gray-400">
        <div class="flex flex-col">
          <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="items-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
            Sign Up
          </button>
        </div>
      </p>
